...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler}  className="flex-1 bg-blue-50/50 text-gray-600 hufull overflow-scroll">
...
<input type="text" placeholder='Type here' className='w-full max-w-lg mt-2 p-2 outline-none border border-gray-300 rounded' value={title} onChange={(e)=>setTitle(e.target.value)} />
<p className='mt-4'>Subtitle</p>
<input type="text" placeholder='Type here' className='w-full max-w-lg mt-2 p-2 outline-none border border-gray-300 rounded' value={subTitle} onChange={(e)=>setSubTitle(e.target.value)} />

<p className='mt-4'>Blod Description</p>
